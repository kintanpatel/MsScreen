...
struct HowToUseLabel : View {
    var text : String
    var body: some View{
        Text(text).font(.system(size: 12)).applyapplyForegroundStyle(.white).padding(.vertical,2).padding(.horizontal,24)
    }
}
